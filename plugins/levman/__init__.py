...
#        return
    ...
    def eddy_correct(self):
        ...
        if self.visit.SourceTaxonomy=="HCP":
            if self.visit.rebuild!=True  and 
            ( os.path.isfile("%s/reg2brain.data.nii.gz" %(self.visit.tractographypath)) or os.path.isfile("%s/reg2brain.data.nii" %(self.visit.tractographypath))):
