...
if [ -z ${CRUSH_DATASET_ROOT+x} ];then
 echo "CRUSH_DATASET_ROOT variable not set.  Set to directory above project/dataset/.  For example if project is ~/projects/rrg-jlevman/shared/abide/dataset, set to ~/projects/rrg-jlevman/shared "
fi

PATIENT_QUEUE=$CRUSH_PATH/../data/abide-queue
ROOT_DIR=$CRUSH_DATASET_ROOT/shared/abide/dataset
